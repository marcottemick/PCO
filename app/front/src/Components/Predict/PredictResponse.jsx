...
Au niveau histologique, on note une hyperprolifération acanthocytaire associée à une augmentation quantitative et qualitative des kératinocytes matures (parakératose). L'épithélium épineux présente une orthokératose au centre, avec formation de micropapilles et parfois des acanthomes. Les espaces intercellulaires sont étroits et remplis de leucocytes polymorphes, principalement des neutrophiles. On retrouve également des granules de Munro et des mousseaux de Touton. Au niveau du tissu adnexe, il existe une infiltration inflammoire composée majoritairement de lymphocytes T helper 1 et de neutrophiles.
Immunohistochimie :
Pour confirmer notre hypothèse diagnostique, nous avons réalis plusieurs marques immunhistochimiques. Nous avons détecté une expression importante de l'anticorps anti-HLA DR4 dans les cellules inflammatoires, ce qui est consistant avec un psoriasis. De plus, on observe une forte expression de CD86, marqueur des macrophages activés, ainsi qu'une faible expression de FOXP3, indice d'une activation Th1 dominante.
Conclusion :
Ce compte rendu anatomopathologique décrit les aspects macroscopiques et microscopiques observés dans cette biopsie cutanée provenant d'une plaque psoriatique. Les résultats histologiques ont montré une hyperprolifération acanthocytaire, une parakératose et une orthokératose, ainsi qu'une importante infiltration inflammatoire. Des marques immunhistochimiques ont été effectuées pour confirmer notre hypothèse diagnostique, et les résultats obtenus sont compatibles avec un psoriasis.
